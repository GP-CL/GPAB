...
const CALENDAR_EMAIL = 'info@khdreamlife.com'; // Doctor's Gmail
    ...
    html: `
      <div style="font-family: Arial, sans-serif; padding: 20px; color: #333;">
        ...
        <table style="border-collapse: collapse; margin-top: 10px; margin-bottom: 20px;">
          <tr>
            <td style="padding: 8px 12px;"><strong>Patient Name:</strong></td>
          ...
          <tr>
            <td style="padding: 8px 12px;"><strong>Patient Email:</strong></td>
...
app.post('/api/book-appointment', async (req, res) => {
  try {
    ...
    await sendConfirmationEmail_Patient(email, name, displayDate, timeDisplay, mode);
    await sendConfirmationEmail_Doctor(email, name, displayDate, timeDisplay, mode);
